...
import com.android.blue.smarthomefunc.entity.RequestCode;
...
public class ImageUtils {
    ...
    public static void startCorp(Activity activity, Uri uri) {
        ...
        intent.putExtra("outputX", MusicCoverLoaderUtils.THUMBNAIL_MAX_LENGTH);
        intent.putExtra("outputY", MusicCoverLoaderUtils.THUMBNAIL_MAX_LENGTH);
